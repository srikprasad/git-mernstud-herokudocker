class StudentAll extends React.Component{   
  ...
  state= {  name: '' ,address: '',email:'' ,contact:'' ,id:'' ,Buttontxt:'Save', Buttontxt1:'Display', data1:[] }
   handleChange = (event) => {  
...
EditData(item){           
  ...
  <form>  
    <div className="col-sm-12 col-md-12"  style={{marginLeft:'0px'}}>   
...
<div className="col-sm-12 col-md-12 "  style={{marginTop:'50px',marginLeft:'20px'}} >  
